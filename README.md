...
- [minio-rust](https://github.com/Rana-Faraz/minio-rust) - Rust rewrite of MinIO for exploring fast, memory-safe object storage.
- [slack-gh-cli](https://github.com/Rana-Faraz/slack-gh-cli) - Local Slack CLI built to feel closer to `gh` for Slack user workflows.
